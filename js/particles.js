/**
 * Premium Armenia Tours - Canvas Particles Module
 * Neon green drifting glass orb/particle system with soft interactive repulsion physics.
 */

const PARTICLES_ENABLED = !window.matchMedia("(prefers-reduced-motion: reduce)").matches && window.innerWidth >= 1024;
