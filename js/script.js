...
window.generateBookingMessage = function() {
    ...
    // 3. Формируем сообщения с новой строкой про гида
    const messages = {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateCalculator() {
    ...
    if (isAgreement) {
      // Show "By Agreement" instead of numeric price
  ...
  const teamData = [
    ...
    image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400" // Փոխեք սա Մարատի իրական նկարի հղումով
  },
  {
    id: "Arthur",
    ...
    image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400" // Փոխեք սա Արթուրի իրական նկարի հղումով
  },
