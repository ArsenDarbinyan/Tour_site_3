...
const translations = {
  hy: {
    ...
    calc_type_agreement: "Մեծ խումբ (8+ անձ) — Պայմանավորվածությամբ",
    calc_by_agreement: "Պայմանավորվածությամբ",
    calc_price_per_person: "Անձի արժեքը՝",
    calc_total: "Ընդհանուր արժեքը՝",
    calc_guide_title: "Անհատական ուղեկցորդ",
    calc_guide_subtitle: "Պրոֆեսիոնալ գիդ (+20,000 ֏)",
  ...
  ru: {
    ...
    calc_type_agreement: "Большая группа (8+ чел) — По договорённости",
    calc_by_agreement: "По договорённости",
    calc_price_per_person: "Цена за человека:",
    calc_total: "Общая стоимость:",
    calc_guide_title: "Услуги гида",
    calc_guide_subtitle: "Профессиональный гид (+20 000 ֏)",
  ...
  en: {
    ...
    calc_type_agreement: "Large Group (8+ pax) — By Agreement",
    calc_by_agreement: "By Agreement",
    price_from_label: "From (1-3)",
    ...
    calc_guide_subtitle: "Professional guide (+20,000 ֏)",
...
const toursData =[
...

  {
    ...
    stops: [
      ...
      {
        title: { hy: "Գեղարդի վանք", ru: "Монастырь Гегард", en: "Geghard Monastery" },
        desc: {
          hy: "ՅՈՒՆԵՍԿՕ-ի համաշխարհային ժառանգության մաս կազմող միջնադարյան վանական համալիր, որի մի մասը փորված է ժայռերի մեջ:",
          ru: "Уникальный средневековый монастырский комплекс, внесенный в список ЮНЕСКО, часть храмов которого высечена прямо в скалах.",
          en: "A unique medieval monastery complex and UNESCO World Heritage site, with several churches carved directly into the solid rock."
        },
        photo: "/img/img_garni-geghard-azat-symphony_11.jpg" // Измените индекс или путь, если необходимо
      },
      {
...

  {
    ...
    title: {
      hy: "Սյունյաց  Հրաշքներ. Տաթև և Սյունիք (2 օր)",
...

  {
    ...
    title: {
      hy: "Խոր Վիրապ  Նորավանք Ջերմուկ ",
      ru: "Чудеса Юга: Крылья Татева и Сюник ",
      en: "Wonders of the South: Tatev & Syunik "
    },
    description: {
      hy: "Երկօրյա բացառիկ ճանապարհորդություն դեպի Սյունիքի սիրտը: Քարանձավային քաղաքներ, աշխարհի ամենաերկար ճոպանուղին և հնագույն Մեգալիթներ:",
      ru: "Двухдневное премиальное путешествие к сердцу Сюника. Пещерные города, самая длинная канатная дорога в мире и мегалиты Караунджа.",
    ...
    stops: [
      ...
      {
     title: { hy: "Ջերմուկ", ru: "Джермук", en: "Jermuk" },
        desc: {
          hy: "Հանրահայտ առողջարանային քաղաք՝ հայտնի իր տաք հանքային ջրերով, բուժիչ ըմպելասրահով և գեղեցիկ ջրվեժով:",
          ru: "Знаменитый курортный город, известный своими горячими минеральными источниками, питьевой галереей и живописным водопадом.",
          en: "A famous spa resort town, renowned for its hot mineral springs, healing water gallery, and picturesque waterfall."
        },
        photo: "/img/img_jermuk.jpg" // Замените путь на ваш актуальный файл
      },
      {
        title: { hy: "Գիշերակաց Գորիսում", ru: "Ночевка в Горисе", en: "Overnight in Goris" },
        desc: {
          hy: "Հարմարավետ կանգառ Սյունիքի սրտում՝ Տաթևի վանք, Խնձորեսկ և Կարահունջ այցելելուց առաջ:",
          ru: "Уютная остановка в сердце Сюника, идеальная для отдыха перед посещением Татевского монастыря, Хնձորեսկa и Караунджа.",
          en: "A cozy stopover in the heart of Syunik, perfect for resting before visiting Tatev Monastery, Khndzoresk, and Karahunj."
        },
        photo: "/img/img_goris_overnight.jpg" // Замените путь на ваш актуальный файл
      },
...

  {
    ...
    stops: [
      ...
      {
        "title": {
          "hy": "Գյումրու «Յոթ Վերք» Եկեղեցի",
          "ru": "Храм «Семь Ран» в Гюмри",
          "en": "Seven Wounds Church of Gyumri"
        },
        "desc": {
          "hy": "Բացահայտեք Գյումրու հոգևոր սիրտը. յուրօրինակ պատկերակալով տաճար, որը վերապրել է կործանարար երկրաշարժերն ու պահպանել իր հզոր էներգիան:",
          "ru": "Духовное сердце Гюмри. Посетите величественный собор с уникальным иконостасом, уцелевший в катастрофических землетрясениях и ставший символом возрождения города.",
          "en": "The spiritual heart of Gyumri. Explore a majestic cathedral with a unique iconostasis that survived devastating earthquakes and stands as a symbol of resilience."
        },
        photo: "/img/img_gyumri-cultural-capital_7.jpg"
      },
      {
        "title": {  
          "hy": "Մարմաշենի Վանական Համալիր",
          "ru": "Средневековый Монастырь Мармашен",
          "en": "Medieval Marmashen Monastery"
        },
        "desc": {
          "hy": "Կարմիր տուֆից կերտված հայկական ճարտարապետության գլուխգործոց՝ Ախուրյան գետի ափին: Զգացեք միջնադարյան Անիի շունչն ու բնության խաղաղությունը:",
          "ru": "Шедевр армянского зодчества из красного туфа на берегу реки Ахурян. Почувствуйте дух легендарной столицы Ани вдали от шумных туристических маршрутов.",
          "en": "A red-tuff masterpiece of Armenian architecture nestled on the Akhuryan riverbank. Feel the spirit of the ancient capital Ani in a serene, untouched landscape."
        },
        photo: "/img/img_gyumri-cultural-capital_8.jpg"
      }
  ...
  },
  {
    ...
    region: "Kotayk",
    duration: 1,
    image: "/img/img_tsaghkadzor-sevan-adventure_2.jpg",
    title: {
  ...
  },
  {
    ...
    stops: [
      ...
      {
        "title": {"hy": "Նորատուսի Խաչքարերի","ru": "Легенды Норатусских","en": "Noratus Khachkars"},
        "desc": {
          "hy": "Մշակութային ճանապարհորդություն դեպի աշխարհի ամենամեծ խաչքարերի անտառ. բացահայտեք դարավոր քարե արվեստն ու միջնադարյան լեգենդները Սևանի ափին:",
          "ru": "Историческое погружение в крупнейший в мире «лес хачкаров». Откройте для себя средневековые каменные стелы и вековые легенды на берегу Севана.",
          "en": "A cultural journey into the world's largest forest of khachkars. Discover centuries-old stone-carving artistry and medieval legends by the shores of Lake Sevan."
        },
...

{
    ...
    stops: [
      ...
      {
        title: { hy: "«Տաթևի թևեր» ճոպանուղի", ru: "Канатная дорога «Крылья Татева»", en: "Wings of Tatev Cable Car" },
        desc: {
...

{
  ...
  {
    "id": "sevan-sevanavank-haghartsin-dimac",
    "price": 40000,
    "region": "Gegharkunik, Tavush",
    "duration": 1,
    "image": "/img/img_sevan-dilijan-tavush_1.jpg", 
    "title": {
      "hy": "Սևան, Սևանավանք, Հաղարծին և Դիմաց լեռ",
      "ru": "Севан, Севанаванк, Агарцин и гора Димац",
      "en": "Sevan, Sevanavank, Haghartsin & Mount Dimac"
    },
    "description": {
      "hy": "Բացահայտեք Դիլիջանի անտառներն ու Սևանի լազուրը, իսկ հետո հզոր ամենագնացներով բարձրացեք Դիմաց լեռան կատարը: *Ուշադրություն. Ջիպ-տուրի նվազագույն արժեքը՝ 40,000 դրամ (4 անձի համար, յուրաքանչյուր հավելյալ տեղը՝ 10,000 դրամ)*:",
      "ru": "Покорите лазурные берега Севана, туманные леса Дилижана и отправьтесь в захватывающий джип-тур на вершину горы Димац. *Внимание: Минимальный заказ для джипинга — 40,000 драм (до 4 человек, каждое доп. место — 10,000 драм)*.",
      "en": "Explore the azure shores of Sevan, Dilijan's lush forests, and experience a thrilling off-road Jeep tour to the peak of Mount Dimac. *Note: Minimum booking for the Jeep tour is 40,000 AMD (for up to 4 people, 10,000 AMD per extra person)*."
    },
    "stops": [
      {
        "title": { "hy": "Սևանա լիճ և Սևանավանք", "ru": "Озеро Севан и Монастырь Севанаванк", "en": "Lake Sevan & Sevanavank Monastery" },
        "desc": {
          "hy": "Հայաստանի կապույտ մարգարիտը և IX դարի հնամենի վանքը թերակղզու բարձունքում, որտեղից բացվում է հիասքանչ տեսարան:",
          "ru": "Голубая жемчужина Армении и старинный монастырь IX века на вершине полуострова с панорамным видом на озеро.",
          "en": "The blue pearl of Armenia and an ancient 9th-century monastery perched on the peninsula with breathtaking lake views."
        },
        "photo": "/img/img_sevan-dilijan-tavush_1.jpg"
      },
      {
        "title": { "hy": "Հաղարծնի վանական համալիր", "ru": "Монастырь Агарцин", "en": "Haghartsin Monastery" },
        "desc": {
          "hy": "Հեքիաթային վանական համալիր՝ թաքնված Դիլիջանի խիտ ու մշտադալար անտառների խորքում:",
          "ru": "Сказочный монастырский комплекс, спрятанный в густых и вечнозеленых лесах Дилижана.",
          "en": "A fairytale monastery complex hidden deep within the lush, emerald forests of Dilijan."
        },
        "photo": "/img/img_sevan-dilijan-haghartsin-parz_5.jpg"
      },
      {
        "title": { "hy": "Ջիպինգ դեպի Դիմաց լեռ", "ru": "Джип-тур на гору Димац", "en": "Jeep Tour to Mount Dimac" },
        "desc": {
          "hy": "Ադրենալինով լի վերելք ամենագնացներով դեպի Դիմաց լեռան տպավորիչ ժայռերն ու ամպերից բարձր գտնվող տեսահարթակը:",
          "ru": "Захватывающий подъем на мощных внедорожниках к культовым отвесным скалам горы Димац и смотровой площадке выше облаков.",
          "en": "An adrenaline-fueled off-road ascent to the dramatic vertical cliffs of Mount Dimac and its panoramic viewpoint above the clouds."
        },
        "photo": "/img/img_sevan-sevanavank-haghartsin-dimac_3.jpg"
      }
    ]
},

{
    "id": "gyumri-sev-berd-trchkan-shirakamut",
    "price": 65000,
    "priceSmall": 65000,
    "priceLarge": 75000,
    "region": "Shirak, Lori",
    "duration": 1,
    "image": "/img/img_gyumri-cultural-capital_5.jpg", 
    "title": {
      "hy": "Գյումրի, Սև Բերդ և Քայլարշավ դեպի Թռչկան ջրվեժ",
      "ru": "Гюмри, Черная Крепость и трекинг к водопаду Трчкан",
      "en": "Gyumri, Black Fortress & Trekking to Trchkan Waterfall"
    },
    "description": {
      "hy": "Բացահայտեք Գյումրու պատմական հմայքը, իսկ հետո Շիրակամուտ գյուղից սկսեք տպավորիչ քայլարշավ դեպի Հայաստանի ամենաբարձրահոս ջրվեժը՝ Թռչկան:",
      "ru": "Откройте для себя исторический шарм Гюмри, а затем отправляйтесь из села Ширакамут в незабываемый пеший поход к самому полноводному водопаду Армении — Трчкан.",
      "en": "Discover the historical charm of Gyumri, and then set off from Shirakamut village on an unforgettable hiking trek to Armenia's highest-volume waterfall — Trchkan."
    },
    "stops": [
      {
        "title": { "hy": "Սև Բերդ (Սև Ամրոց)", "ru": "Черная Крепость (Сев Берд)", "en": "Black Fortress (Sev Berd)" },
        "desc": {
          "hy": "XIX դարի մոնումենտալ ռազմական ամրոց Գյումրիում՝ հայտնի իր յուրօրինակ կլոր կառուցվածքով և հզոր պատմությամբ:",
          "ru": "Монументальное оборонительное сооружение XIX века в Гюмри, известное своей круглой архитектурой и мощной акустикой.",
          "en": "A monumental 19th-century military fortress in Gyumri, famous for its unique circular architecture and powerful acoustics."
        },
        "photo": "/img/img_gyumri-cultural-capital_5.jpg"
      },
      {
        "title": { "hy": "Կումայրի պատմական կենտրոն", "ru": "Исторический центр Кумайри", "en": "Kumayri Historic District" },
        "desc": {
          "hy": "Զբոսանք Գյումրու հին թաղամասով. XIX դարի սև և կարմիր տուֆից կերտված ինքնատիպ փողոցներ ու կոլորիտային պատշգամբներ:",
          "ru": "Прогулка по старому кварталу Гюмри: аутентичные улочки и колоритные дома XIX века из черного и красного туфа.",
          "en": "A walk through Gyumri's oldest district, featuring authentic 19th-century streets and buildings crafted from black and red tuff."
        },
        "photo": "/img/img_gyumri-cultural-capital_6.jpg"
      },
      {
        "title": { "hy": "Շիրակամուտ գյուղ (Նալբանդ)", "ru": "Село Ширакамут (Налбанд)", "en": "Shirakamut Village (Nalband)" },
        "desc": {
          "hy": "Պատմական գյուղ Փամբակի հովտում (1988թ. երկրաշարժի էպիկենտրոն), որտեղից սկսվում է մեր գեղատեսիլ արշավային երթուղին:",
          "ru": "Живописное село в Памбакской долине (эпицентр землетрясения 1988 года), откуда начинается наш пеший маршрут к дикой природе.",
          "en": "A picturesque village in the Pambak valley (the epicenter of the 1988 earthquake), serving as the starting point of our scenic hiking trail."
        },
        "photo": "/img/img_gyumri-sev-berd-trchkan-shirakamut_3.jpg"
      },
      {
        "title": { "hy": "Քայլարշավ և Թռչկան ջրվեժ", "ru": "Пеший поход и водопад Трчкан", "en": "Hiking & Trchkan Waterfall" },
        "desc": {
          "hy": "Գեղատեսիլ կիրճով քայլարշավ դեպի Չիչխան գետի վրա գտնվող 22-մետրանոց հիասքանչ ջրվեժը, որտեղ կարելի է տեսնել վեր թռչող իշխան ձկներին:",
          "ru": "Пеший трекинг по живописному ущелью к величественному 22-метровому водопаду на реке Чичхан, где можно увидеть прыгающую против течения форель.",
          "en": "A scenic trek through the gorge to the magnificent 22-meter waterfall on the Chichkhan River, famous for trout leaping upstream."
        },
        "photo": "/img/img_gyumri-sev-berd-trchkan-shirakamut_4.jpg"
      }
    ]
  }
];
...
const landmarksLibrary = {
  ...
  Khor_Virap: {
    ...
    desc: { hy: "Հայաստանի սիրտը, որտեղից բացվում է լավագույն տեսարանը դեպի սուրբ Արարատ լեռը:", ru: "Сердце Армении, откуда открывается самый близкий и величественный вид на гору Арарат.", en: "The cradle of Armenian Christianity with a breathtaking, close-up view of sacred Mount Ararat." },
